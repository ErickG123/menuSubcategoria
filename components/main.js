...
// Parent null significa que é o elemento inicial da árvore
// Parente sugido de um número significa que o elemento é filho de outro elemento
// Elemento 'Desktops' é filho do elemento 'Computers' 
const menu = [
